            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php if (isAdministrator($grupo["GRU_CODIGO"])): ?>
                        ...
                        <a href="grupos/lista/" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Lista de Compras"><i class="fa fa-list"></i></a>
                    <?php endif; ?>
                        ...
                        foreach ($nomes as $nome):
                            ...
                            <form method="post" action="membro/editar/<?php echo $grupo["GRU_CODIGO"]; ?>/">
